...
namespace Gemstone.PQDIF.Logical
{
    ...
    public class ChannelInstance : IEquatable<ChannelInstance>
    {
        ...
        /// </summary>
        /// <exception cref="InvalidDataException">ChannelDefinitionIndex element not found in channel instance.</exception>
        public uint ChannelDefinitionIndex
        {
            get
            {
                ScalarElement channelDefinitionIndexElement = m_physicalStructure.GetScalarByTag(ChannelDefinition.ChannelDefinitionIndexTag)
                    ?? throw new InvalidDataException("ChannelDefinitionIndex element not found in channel instance.");
        ...
        /// </summary>
        /// <exception cref="InvalidDataException">SeriesInstances element not found in channel instance.</exception>
        public IList<SeriesInstance> SeriesInstances
        {
            get
            {
                CollectionElement seriesInstancesElement = m_physicalStructure.GetCollectionByTag(SeriesInstancesTag)
                    ?? throw new InvalidDataException("SeriesInstances element not found in channel instance.");

                return seriesInstancesElement
        ...
        public void Remove(SeriesInstance seriesInstance)
        {
            ...
            List<CollectionElement> seriesInstanceElements = seriesInstancesElement.GetElementsByTag(OneSeriesInstanceTag).Cast<CollectionElement>().ToList();
        ...
        public override bool Equals(object? obj) => 
            obj is ChannelInstance other && Equals(other);

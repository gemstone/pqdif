...
namespace Gemstone.PQDIF.Logical
{
    ...
    public class ChannelDefinition : IEquatable<ChannelDefinition>
    {
        ...
        /// </summary>
        /// <exception cref="InvalidDataException">Phase element not found in channel definition.</exception>
        public Phase Phase
        {
            get
            {
                ScalarElement phaseElement = m_physicalStructure.GetScalarByTag(PhaseIDTag)
                    ?? throw new InvalidDataException("Phase element not found in channel definition.");

                return (Phase)phaseElement.GetUInt4();
            }
            set
            {
        ...
        /// </summary>
        /// <exception cref="InvalidDataException">QuantityTypeID element not found in channel definition.</exception>
        public Guid QuantityTypeID
        {
            get
            {
                ScalarElement quantityTypeIDElement = m_physicalStructure.GetScalarByTag(QuantityTypeIDTag)
                    ?? throw new InvalidDataException("QuantityTypeID element not found in channel definition.");

                return quantityTypeIDElement.GetGuid();
            }
            set
            {
        ...
        /// </summary>
        /// <exception cref="InvalidDataException">QuantityMeasured element not found in channel definition.</exception>
        public QuantityMeasured QuantityMeasured
        {
            get
            {
                ScalarElement quantityMeasuredElement = m_physicalStructure.GetScalarByTag(QuantityMeasuredIDTag)
                    ?? throw new InvalidDataException("QuantityMeasured element not found in channel definition.");

                return (QuantityMeasured)quantityMeasuredElement.GetUInt4();
            }
            set
            {
        ...
        /// </summary>
        /// <exception cref="InvalidDataException">SeriesDefinitions element not found in channel definition.</exception>
        public IList<SeriesDefinition> SeriesDefinitions
        {
            get
            {
                ...
                return seriesDefinitionsElement
        ...
        public override int GetHashCode() =>
            m_physicalStructure.GetHashCode();
